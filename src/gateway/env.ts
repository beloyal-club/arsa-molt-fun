...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  // YouTube API
  if (env.YOUTUBE_CLIENT_ID) envVars.YOUTUBE_CLIENT_ID = env.YOUTUBE_CLIENT_ID;
  if (env.YOUTUBE_CLIENT_SECRET) envVars.YOUTUBE_CLIENT_SECRET = env.YOUTUBE_CLIENT_SECRET;
  if (env.YOUTUBE_REDIRECT_URI) envVars.YOUTUBE_REDIRECT_URI = env.YOUTUBE_REDIRECT_URI;
